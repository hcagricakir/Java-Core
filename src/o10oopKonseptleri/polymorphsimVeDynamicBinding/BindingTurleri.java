package o10oopKonseptleri.polymorphsimVeDynamicBinding;
...
public class BindingTurleri {
    public static void main(String[] args) {
       /* UstSinif.adiniSoyleStatic();
        ...
        UstSinif ustSinif1 = new AltSinif(); //dynamic binding
...
class UstSinif {
    public static void adiniSoyleStatic() { //static override edilemiyor.
